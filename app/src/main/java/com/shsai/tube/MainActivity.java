...
public class MainActivity extends Activity {
  ...
  private SHSTubeWebview web;
  private static final String DEV_NAME = "SHS";
  private static final String TG_URL = "https://t.me/aamoviesofficial";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    SharedPreferences prefs = getSharedPreferences("SHSTUBE", MODE_PRIVATE);
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
            ...
            if (url.contains("youtube.com/ytpro_cdn/")) {
                ...
                try {
                    ...
                    connection.setRequestProperty("User-Agent", "SHSTUBE");
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    if (item.getItemId() == 1) {
      new AlertDialog.Builder(this)
        .setTitle("SHS Tube")
        .setMessage("Developer: SHS\n\nTelegram: t.me/aamoviesofficial")
        .setPositiveButton("Join Telegram", (d, w) -> {
          Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(TG_URL));
          startActivity(i);
        })
